...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Papi~mike",
    ownernumber: process.env.Owner_Number || "18294797498",
    ...
    sessionId: process.env.SESSION_ID || "fEOpap9XJXzbmY_A_N_Y_A_V_2_U9FnAl",
